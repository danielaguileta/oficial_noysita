   ...
   <div class="col-md-12"><br>
    <div class="card card-primary">
      ...
      <div class="col-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nombre_cliente" name="nombre_cliente" placeholder=""value="{{old('nombre_cliente',$facturas['NOMBRE'])}}">
    ...
    <div class="row">
      <div class="col-6">
        <div class="form-group">
            <label for="">RTN</label>
            <input type="number" class="form-control" id="rtn" name="rtn" placeholder="" value="{{old('rtn',$facturas['RTN'])}}">
            @error('rtn')
            <span class="text-danger">{{$message}}</span>
            @enderror
          </div>
