...
class empleadoscontroller extends Controller
{
    ...
    {
        $empleados = Http::get('https://oficialnoysita-production.up.railway.app/empleados/')->json();
    ...
    {
        $empleados = Http::post('https://oficialnoysita-production.up.railway.app/insertar_empleado', [
    ...
    {
        $empleados = Http::put('https://oficialnoysita-production.up.railway.app/empleados/edit/' .$COD_EMPLEADO ,[
            'NOMBRE_EMPLEADO'=> $request->nombre,
            'IDENTIDAD_EMPLEADO' => $request->identidad,
            'EDAD_EMPLEADO' => $request->edad,
            'CORREO_EMPLEADO'=> $request->correo_empleado,
    ...
    {
        $empleados = Http::delete('https://oficialnoysita-production.up.railway.app/empleados/delete/'. $COD_EMPLEADO);
